            ...
            >
              <div className="flex flex-col xl:flex-row items-center gap-x-4">
                ...
                <div className="w-64 flex flex-col gap-y-2">
                  <div className="text-lg leading-none font-bold">{`${ev.location.city}, ${ev.location.country}`}</div>
                  <div className="flex items-center gap-x-1 justify-center xl:justify-start">
                    <div className="text-accent text-lg">
                        <RiMap2Line />
                    </div>
                    <div className="font-light">{ev.location.address}</div>
                  </div>
                </div>
              </div>
              <div className="w-[100px] text-[17px] text-center text-accent font-bold">{ev.priceRange}</div>
